...
pub fn proc_derive_persisted(input: TokenStream) -> TokenStream {
    ...
    for field in fields {
        ...
        let from_assignment = if persisted_type.is_some() {
            quote! { #field_name: crate::settings::persistence::FromPersisted::from_persisted(persisted.#field_name) }
        } else {
    ...
    let expanded = quote! {
        ...
        #(#struct_serde_attrs)*
        pub(super) struct #persisted_name {
            #(#persisted_fields,)*
        }
        ...
        impl crate::settings::persistence::FromPersisted<#persisted_name> for #original_name {
