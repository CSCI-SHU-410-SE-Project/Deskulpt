...
export const commands = {
   ...
   */
  emitOnRenderReady: (payload: { event: RenderWidgetsEvent }) =>
   ...
   */
  exitApp: (payload: { settings: Settings }) =>
   ...
   */
  openWidget: (payload: { id: string | null }) =>
   ...
   */
  rescanWidgets: () =>
    invoke<{ [key in string]: WidgetConfig }>("rescan_widgets"),
   ...
   */
  updateSettings: (payload: { update: SettingsUpdate }) =>
